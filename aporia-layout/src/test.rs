...
use crate::node::{
    ...
    RatioLayoutNode, ResolvedLayout,
};
...
fn grid_alignment() {
    ...
    assert_eq!(c1_res.rect.width, 100.0);
    assert_eq!(c1_res.rect.height, 200.0);

    assert_eq!(c1_res.rect.x, 0.0);
    assert_eq!(c1_res.rect.y, 0.0);
    assert_eq!(c2_res.rect.x, 110.0);
    assert_eq!(c2_res.rect.y, 150.0);
}
